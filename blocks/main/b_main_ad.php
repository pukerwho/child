<div class="b_ad">
	...
	<div class="container p-relative">
		...
		<div class="row align-items-center">
			<?php $custom_query_news = new WP_Query( array( 'post_type' => 'ad', 'posts_per_page' => -1) );
				...
				<div class="col-md-6">
					<div class="b_ad__item">
						...
						<div class="b_ad__item-text">
							Успіх починається з мрії. Ми допомагаємо дітям повірити в себе та не зупинятися на шляху до мети. Успіх починається з мрії. Ми допомагаємо дітям повірити в себе та не зупинятися на шляху до мети. 
						</div>
