...
<div class="single">
	...
	<div class="single__welcome" style="background-color: #1664da;">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
	...
	<div class="container">
		<div class="row mb-25">
			<?php if(carbon_get_the_post_meta('crb_news_description')): ?>
			<div class="col-md-10">
	...
	<?php if(carbon_get_the_post_meta('crb_news_photos')): ?>
	<div class="container">
		<div class="row mb-40">
			<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="swiper-container single-gallery-swiper">
						<div class="swiper-wrapper">
							<?php 
							$news_photos = carbon_get_the_post_meta('crb_news_photos');
							foreach ( $news_photos as $news_photo ): ?>
								<?php $photo_src = wp_get_attachment_image_src($news_photo, 'large'); ?>
