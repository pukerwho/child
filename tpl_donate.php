...
<section id="p_donate">
	<div class="p_donate">
		...
		<div class="p_donate__buttons d-flex justify-content-center">
			<div class="p_donate__button p_donate__button-active" onclick="showDonats(event, 'OneTime')">
				<?php _e('Разова допомога', 'child-theme'); ?>
			</div>
			<div class="p_donate__button" onclick="showDonats(event, 'AllTime')">
				<?php _e('Регулярна допомога', 'child-theme'); ?>
			</div>
		</div>
		<div class="container">
			<div id="OneTime" class="row tabcontent-donate">
				<div class="col-md-12">
			...
			<div id="AllTime" class="row tabcontent-donate">
				<div class="col-md-12">
					<div class="p_donate__flex">
						<div class="p_donate__item-first">
							<div class="p_donate__subtitle">
