				...
				<div class="col-md-12">
					<div class="swiper-container single-gallery-swiper">
						<div class="swiper-wrapper">
							<?php 
							$projects_photos = carbon_get_the_post_meta('crb_projects_photos');
							foreach ( $projects_photos as $projects_photo ): ?>
								<?php $photo_src = wp_get_attachment_image_src($projects_photo, 'large'); ?>
